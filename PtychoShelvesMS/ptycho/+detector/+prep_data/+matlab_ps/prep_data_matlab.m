...
% While ZC removed mask in hard code, I (AB at UVic need it!)
% fmask = true; % quick remove mask by Zhen Chen
%
...
% assume no mask and quick remove by Zhen Chen
% p.fmask = true;
% clear fmask 
% precalculate modulus of data, normalize and fftshift
p.fmag = fftshift_2D(sqrt(data)) * p.renorm; % PUT THIS BACK IN FOR
% PROPPER ML ALGO....
% for debugging AB:
% p.fmag = fftshift_2D(sqrt(data));
