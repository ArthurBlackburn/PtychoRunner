...
% that below this level it is incoherent noise. Added as an option by A.B. at UVic.

if isfield(p,'dp_Pedestals_incoherent') && isnumeric(p.dp_Pedestals_incoherent) ...
        && ~isnan(p.dp_Pedestals_incoherent) ...
        && (p.dp_Pedestals_incoherent>0)
    detStorage.data(detStorage.data < p.dp_Pedestals_incoherent) = 0;
end
